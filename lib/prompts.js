...
const SKIP_AI = false;
const PROMPTS = {
  start: `We are going to be generating a series of PlayWright interactive end-to-end JavaScript tests, use ESM syntax. I will provide you with HTML in the next message. As part of this conversation, do not generate duplicate tests for the same components, instead find new ones in the given HTML."
